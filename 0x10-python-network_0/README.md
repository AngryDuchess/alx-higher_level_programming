# Python - Network
This project goes in depth into the HTTP protocol. From introducing how to define a port number in a url, what query strings are and how to use them, the structure of HTTP headers, to what cookies are and what they are used for and also how to set them.
## Resources
